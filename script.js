...
// eslint-disable-next-line no-undef
  document.getElementById(i).addEventListener('mousedown', () => {
    ...
    // eslint-disable-next-line no-undef
    if (document.getElementById(i).innerHTML === 'CapsLock') {
      !capced;
      capced ? keyboard.uppertext() : keyboard.lowertext();
    }
    if (document.getElementById(i).innerHTML === 'Backspace') document.getElementById('inp').value = document.getElementById('inp').value.slice(0, -1);
    if (!(document.getElementById(i).innerHTML === 'Backspace') && !(document.getElementById(i).innerHTML === 'Tab')
    && !(document.getElementById(i).innerHTML === 'CapsLock') && !(document.getElementById(i).innerHTML === 'Enter') && !(document.getElementById(i).innerHTML === 'ShiftLft')
    && !(document.getElementById(i).innerHTML === 'ShiftRght') && !(document.getElementById(i).innerHTML === 'up')
    && !(document.getElementById(i).innerHTML === 'CtrlL') && !(document.getElementById(i).innerHTML === 'Win')
    && !(document.getElementById(i).innerHTML === 'AltL') && !(document.getElementById(i).innerHTML === 'AltR')
    && !(document.getElementById(i).innerHTML === 'CtrlR') && !(document.getElementById(i).innerHTML === 'left')
    && !(document.getElementById(i).innerHTML === 'down') && !(document.getElementById(i).innerHTML === 'right')) {
      if (document.getElementById(i).innerHTML === 'Space') document.getElementById('inp').value += ' ';
      else document.getElementById('inp').value += document.getElementById(i).innerHTML;
    }
  });
});
idList.forEach((i) => {
